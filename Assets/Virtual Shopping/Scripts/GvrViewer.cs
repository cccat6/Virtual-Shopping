...
public class GvrViewer : MonoBehaviour {
  ...
  public DistortionCorrectionMethod DistortionCorrection {
    ...
    set {
      if (device != null) {
        value = DistortionCorrectionMethod.None;
      }
      if (value != distortionCorrection && device != null) {
        device.SetDistortionCorrectionEnabled(value == DistortionCorrectionMethod.None);
  ...
  [SerializeField]
  private DistortionCorrectionMethod distortionCorrection = DistortionCorrectionMethod.None;
  ...
  public static BaseVRDevice device;
  ...
  private void InitDevice() {
    ...
    device.SetDistortionCorrectionEnabled(distortionCorrection == DistortionCorrectionMethod.None);
